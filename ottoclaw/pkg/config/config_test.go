...
func TestDefaultConfig_WorkspacePath_Default(t *testing.T) {
	...
	t.Setenv("OTTOCLAW_HOME", "")
	// Set a known home for consistent test results
	t.Setenv("HOME", "/tmp/home")

	cfg := DefaultConfig()
	want := filepath.Join("/tmp/home", ".ottoclaw", "workspace")
...
func TestDefaultConfig_WorkspacePath_WithPicoclawHome(t *testing.T) {
	t.Setenv("OTTOCLAW_HOME", "/custom/ottoclaw/home")

	cfg := DefaultConfig()
	want := "/custom/ottoclaw/home/workspace"

	if cfg.Agents.Defaults.Workspace != want {
		t.Errorf("Workspace path with OTTOCLAW_HOME = %q, want %q", cfg.Agents.Defaults.Workspace, want)
	}
}
