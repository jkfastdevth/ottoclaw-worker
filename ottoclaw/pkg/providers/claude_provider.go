...
import (
	...
	anthropicprovider "github.com/sipeed/ottoclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: ottoclaw auth login --provider anthropic")
		}
