...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.ottoclaw")
	assert.Equal(t, "/home/user/.ottoclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.ottoclaw/workspace/file.txt", "/home/user/.ottoclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".ottoclaw"), result)
}
