...
func (r *ToolRegistry) ExecuteWithContext(
	...
	name string,
	args map[string]any,
	channel, chatID, agentID, replyTo string,
	...
	// Inject channel/chatID/agentID/replyTo into ctx so tools read them via ToolChannel(ctx)/ToolChatID(ctx)/ToolAgentID(ctx)/ToolReplyTo(ctx).
	// Always inject — tools validate what they require.
	ctx = WithToolContext(ctx, channel, chatID, agentID, replyTo)
