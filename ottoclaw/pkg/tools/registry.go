...
func (r *ToolRegistry) ExecuteWithContext(
	...
	// Inject channel/chatID/agentID into ctx so tools read them via ToolChannel(ctx)/ToolChatID(ctx)/ToolAgentID(ctx).
	// Always inject — tools validate what they require.
	ctx = WithToolContext(ctx, channel, chatID, agentID)
