...
import (
	...
	"github.com/sipeed/ottoclaw/pkg/session"
...
func NewAgentInstance(
	...
	// Enable proactive Akashic Library injection if the search tool is present
	if t, ok := toolsRegistry.Get("siam_search_memory"); ok {
