...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".ottoclaw", "config.json")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".ottoclaw", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("OTTOCLAW_CONFIG", "/tmp/custom/config.json")
